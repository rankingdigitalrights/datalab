...
function createSpreadsheetOutput(Company, filenamePrefix, filenameSuffix, mainSheetMode,addNewStep,stepToAdd) {
    ...
    addSetOfScoringSteps(SS, sheetModeID, Indicators, ResearchSteps, Company, hasOpCom, integrateOutputs, outputParams, isPilotMode,addNewStep,stepToAdd)
