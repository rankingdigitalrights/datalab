  ...
  indicators: [
    ...
    },
    {
      ...
      elements: [
        ...
        'Does the company clearly disclose that a clearly disclose committee, team, program or officer oversees how company practices affect freedom of expression and information?',
        'Does the company clearly disclose that a clearly disclose committee, team, program or officer oversees how company practices affect privacy?',
      ],
      elementsTags: [
      ...
      elementsLinks: [
        ...
        [
          '#glossary-clearlydisclose',
          '#glossary-executiveleveloversight',
          '#glossary-oversight',
        ],
        [
          '#glossary-clearlydisclose',
    ...
    },
    {
      ...
      elements: [
        ...
        'Does the company conduct additional evaluation whenever the company’s risk assessments identify concerns?',
        'Do senior executives and/or members of the company’s board of directors review and consider the results of assessments and due diligence in their decision-making?',
        'Does the company conduct a assessments on a regular schedule?',
        'Are the company’s assessments assured by an external third party?',
        'Is the external third party that assures the assessment accredited to a relevant and reputable human rights standard by a credible organization?',
      ],
      elementsTags: [
    ...
    },
    {
      ...
      elementsLinks: [
        [
          '#glossary-clearlydisclose',
          '#glossary-affecteduser',
          '#glossary-appeal',
          '#glossary-contentmoderation',
        ],
        [
          '#glossary-clearlydisclose',
          '#glossary-notice',
    ...
    },
    {
      ...
      elementsTags: [
        ...
        [
          'personal digital assistant ecosystems',
          'clearly disclose',
          'skills',
          'skill store',
          'advertising content policy',
    ...
    },
    {
      ...
      sources:
        'Advertising policies, guidelines, terms of use, etc. Company Ads or Business Help Center',
    },
    {
      indicator: 'F2d',
    ...
    },
    {
      ...
      descriptionLinks: [
        '#glossary-clearlydisclose',
        '#glossary-advertisingtargetingpolicies',
      ],
      elements: [
      ...
      elementsTags: [
        ...
        [
          'clearly disclose',
          'algorithmically',
          'advertising audience categories',
        ],
        ['clearly disclose', 'advertising content', 'accounts'],
      ],
      elementsLinks: [
        ...
        [
          '#glossary-clearlydisclose',
          '#glossary-algorithm',
          '#glossary-advertisingaudiencecategories',
        ],
        [
          '#glossary-clearlydisclose',
          '#glossary-advertisingcontent',
    ...
    },
    {
      ...
      elements: [
        ...
        'Can the data be exported as a structured data?',
      ],
      elementsTags: [
    ...
    },
    {
      ...
      elements: [
        ...
        'Does the company clearly disclose that it notifies users when it restricts their accounts?',
      ],
      elementsTags: [
        ['clearly disclose', 'content'],
        ['clearly disclose', 'content'],
    ...
    },
    {
      ...
      descriptionTerms: [
        'clearly disclose',
        'shut down or restrict access to the network',
        'protocols',
        'applications',
      ],
      descriptionLinks: [
      ...
      elementsTags: [
        ...
        [
          'clearly disclose',
          'government demands',
          'shut down a network or restrict access to a service',
        ],
        [
          'clearly disclose',
          'government demands',
        ...
        [
          'clearly disclose',
          'shuts down a network or restricts access to a service',
        ],
    ...
    },
    {
      ...
      elementsTags: [['require', 'government-issued identification']],
      elementsLinks: [['#glossary-require', '#glossary-governmentid']],
      guidance:
    ...
    },
    {
      ...
      elementsTags: [
        ...
        [
          'clearly disclose',
          'algorithmic content curation, recommendation, and/or ranking system',
        ],
    ...
    },
    {
      ...
      elementsLinks: [
        ...
        [
          '#glossary-clearlydisclose',
          '#glossary-user',
          '#glossary-audvertisingaudiencecategories',
        ],
    ...
    },
    {
      ...
      elementsTags: [
        [
          'clearly disclose',
          'government entities (including courts or other judicial bodies)',
          'demand',
          'user information',
        ],
        [
      ...
      elementsLinks: [
        [
          '#glossary-clearlydisclose',
          '#glossary-govdemands',
          'https://docs.google.com/document/d/1csFnne1LyCLP1TMylmugABL8RUn9PGVIf49z0tKMtz0/edit#bookmark=id.w0ipnpr2810d',
          '#glossary-userinformation',
        ],
        [
          '#glossary-clearlydisclose',
    ...
    },
    {
      ...
      elementsLinks: [
        [
          '#glossary-clearlydisclose',
          '#glossary-securityresearcher',
          '#glossary-securityvulnerability',
        ],
        ...
        [
          '#glossary-personaldig',
          '#glossary-clearlydisclose',
          '#glossary-securityupdate',
        ],
        [
          '#glossary-personaldig',
          '#glossary-clearlydisclose',
          '#glossary-securityupdates',
          '#glossary-device',
        ],
    ...
    },
    {
      ...
      elementsTags: [['cybersecurity risks']],
      elementsLinks: [['#glossary-cyberrisks']],
      guidance:
