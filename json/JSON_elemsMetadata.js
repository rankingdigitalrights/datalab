var elemsMetadata = {
  ...
  "indicators": [{
      ...
      "elementsLinks": [
        ["#glossary-explicit", "#glossary-policycommitment"],
        ["#glossary-explicit", "#glossary-policycommitment"],
        ["#glossary-explicit", "#glossary-policycommitment"]
      ],
      ...
      "sources": ["Company human rights policy", "Company statements, reports, or other communications that reflect official company policy", "Company annual report or sustainability report", "Company “AI principles” policy"]
    },
    {
      "indicator": "G2",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "board of directors", "oversight"],
        ["clearly disclose", "executive-level", "oversees"],
        ["clearly disclose", "executive-level", "oversees"],
        ["clearly disclose", "clearly disclose", "oversees"],
        ["clearly disclose", "clearly disclose", "oversees"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-boardofdirectors", "#glossary-oversight"],
        ["#glossary-clearlydisclose", "#glossary-boardofdirectors", "#glossary-oversight"],
        ["#glossary-clearlydisclose", "#glossary-executiveleveloversight", "#glossary-oversight"],
        ["#glossary-clearlydisclose", "#glossary-executiveleveloversight", "#glossary-oversight"],
        ["#glossary-clearlydisclose", "#glossary-management", "#glossary-oversight"],
        ["#glossary-clearlydisclose", "#glossary-management", "#glossary-oversight"]
      ],
      ...
      "sources": ["List of board of directors", "Company governance documents", "Company sustainability report", "Company organizational chart", "Company human rights policy", "Global Network Initiative documents (if company is a member)"]
    },
    {
      "indicator": "G3",
      ...
      "elementsTags": [
        ["clearly disclose"],
        ["clearly disclose"],
        ["clearly disclose", "whistleblower program"],
        ["clearly disclose", "whistleblower program"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose"],
        ["#glossary-clearlydisclose"],
        ["#glossary-clearlydisclose", "#glossary-whistleblower"],
        ["#glossary-clearlydisclose", "#glossary-whistleblower"]
      ],
      ...
      "sources": ["Company code of conduct", "Employee handbook", "Company organizational chart", "Company CSR/sustainability report", "Company blog posts"]
    },
    {
      "indicator": "G4a",
    ...
    },
    {
      ...
      "elementsLinks": [
        ["#glossary-hria"],
        ["#glossary-hria"],
        ["#glossary-hria", "#glossary-tos"],
        ["#glossary-hria", "#glossary-privacypolicies"],
        ["#glossary-hria"],
        ["#glossary-seniorleadership", "#glossary-boardofdirectors", "#glossary-hria"],
        ["#glossary-hria"],
        ["#glossary-hria", "#glossary-thirdparty"],
    ...
    },
    {
      ...
      "elementsLinks": [
        ["#glossary-hria", "#glossary-targetedad"],
        ["#glossary-hria", "#glossary-targetedad"],
        ["#glossary-hria", "#glossary-targetedad"],
        ["#glossary-hria"],
        ["#glossary-seniorleadership", "#glossary-boardofdirectors", "#glossary-hria"],
    ...
    },
    {
      ...
      "sources": ["Company CSR/sustainability report", "Company annual report", "Company blog", "Company FAQ or Help Center"]
    },
    {
      "indicator": "G6a",
      "label": "G6(a). Remedy",
      ...
      "elementsTags": [
        ...
        ["clearly disclose​", "grievance mechanism(s)"],
        ["clearly disclose", "remedy", "grievances"],
        ["clearly disclose", "remedy", "grievances"],
        ["clearly disclose", "grievance", "remedy"],
        ["clearly disclose"],
        ["clearly disclose"],
        ["clearly disclose", "remedy", "grievances"],
        ["clearly disclose​", "remedy", "grievances"]
      ...
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-grievance"],
        ["#glossary-clearlydisclose", "#glossary-grievance"],
        ["#glossary-clearlydisclose", "#glossary-remedy", "#glossary-grievance"],
        ["#glossary-clearlydisclose", "#glossary-remedy", "#glossary-grievance"],
        ["#glossary-clearlydisclose", "#glossary-grievance", "#glossary-remedy"],
        ["#glossary-clearlydisclose"],
        ["#glossary-clearlydisclose"],
        ["#glossary-clearlydisclose", "#glossary-remedy", "#glossary-grievance"],
        ["#glossary-clearlydisclose", "#glossary-remedy", "#glossary-grievance"]
      ...
      "sources": ["Company terms of service or equivalent user agreements", "Company content policies", "Company privacy policies, privacy guidelines, or privacy resource site", "Company CSR/sustainability report", "Company help center or user guide", "Company transparency report (for the number of complaints received)", "Company advertising policies"]
    },
    {
      "indicator": "G6b",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "notifies", "affected", "content-moderation action"],
        ["clearly disclose", "notifying", "affected users"],
        ["clearly disclose", "appeals"],
        ["clearly disclose", "appeals"],
        ["clearly disclose", "appeals"],
        ["clearly disclose", "content-moderation action"],
        ["clearly disclose", "appeals"],
        ["clearly disclose", "affected users"],
        ["clearly disclose", "affected users"],
        ["clearly disclose", "appeals"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-affecteduser", "#glossary-appeal", "#glossary-contentmoderation"],
        ["#glossary-clearlydisclose", "#glossary-notice", "#glossary-affecteduser", "#glossary-contentmoderation"],
        ["#glossary-clearlydisclose", "#glossary-notice", "#glossary-affecteduser"],
        ["#glossary-clearlydisclose", "#glossary-appeal"],
        ["#glossary-clearlydisclose", "#glossary-appeal"],
        ["#glossary-clearlydisclose", "#glossary-appeal"],
        ["#glossary-clearlydisclose", "#glossary-contentmoderation"],
        ["#glossary-clearlydisclose", "#glossary-appeal"],
        ["#glossary-clearlydisclose", "#glossary-affecteduser"],
        ["#glossary-clearlydisclose", "#glossary-affecteduser"],
        ["#glossary-clearlydisclose", "#glossary-appeal"]
      ],
      ...
      "sources": ["Company terms of service or user agreements", "Company privacy policies", "Company sustainability report"]
    },
    {
      "indicator": "F1a",
      ...
      "elementsTags": [
        ...
        ["terms of service"],
        ["terms of service", "understandable manner"]
      ],
      "elementsLinks": [
        ["#glossary-tos", "#glossary-easytofind"],
        ["#glossary-tos"],
        ["#glossary-tos", "#glossary-easytounderstand"]
      ],
      ...
      "sources": ["Company terms of service, terms of use, terms and conditions, etc.", "Company acceptable use policy, community guidelines, rules, etc."]
    },
    {
      "indicator": "F1b",
      ...
      "elementsTags": [
        ...
        ["advertising content policies", "understandable manner"],
        ["mobile ecosystems", "clearly disclose", "app store", "advertising content policy"],
        ["personal digital assistant ecosystems", "clearly disclose", "skills", "skill store", "advertising content policy"]
      ],
      "elementsLinks": [
        ["#glossary-advertisingcontentpolicies", "#glossary-easytofind"],
        ["#glossary-advertisingcontentpolicies"],
        ["#glossary-advertisingcontentpolicies", "#glossary-easytounderstand"],
        ["#glossary-mobile", "#glossary-clearlydisclose", "#glossary-appstore", "#glossary-advertisingcontentpolicies"],
        ["#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-skills", "#glossary-skillstore", "#glossary-advertisingcontentpolicies"]
      ],
      ...
      "sources": ["Company advertising policies", "Company business help center", "Company terms of use"]
    },
    {
      "indicator": "F1c",
      ...
      "elementsTags": [
        ...
        ["advertising targeting policies", "users"],
        ["advertising targeting policies", "understandable manner"],
        ["mobile ecosystems", "clearly disclose", "apps", "app store", "advertising targeting policy"],
        ["personal digital assistant ecosystems", "skills", "skill store", "advertising targeting policy"]
      ],
      "elementsLinks": [
        ["#glossary-advertisingcontentpolicies", "#glossary-easytofind"],
        ["#glossary-advertisingcontentpolicies", "#glossary-user"],
        ["#glossary-advertisingcontentpolicies", "#glossary-easytounderstand"],
        ["#glossary-mobile", "#glossary-clearlydisclose", "#glossary-app", "#glossary-appstore", "#glossary-advertisingcontentpolicies"],
        ["#glossary-personaldig", "#glossary-skills", "#glossary-skillstore", "#glossary-advertisingcontentpolicies"]
      ],
    ...
    },
    {
      ...
      "elementsTags": [
        ...
        ["algorithmic system use policies", "understandable manner"]
      ],
      "elementsLinks": [
        ["#glossary-algsysuse", "#glossary-easytofind"],
        ["#glossary-algsysuse"],
        ["#glossary-algsysuse", "#glossary-easytounderstand"]
      ],
      ...
      "sources": ["Algorithmic system use policies", "Guidelines for developing algorithmic systems", "Privacy policy or data policy", "Help center"]
    },
    {
      "indicator": "F2a",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "directly notify", "users"],
        ["clearly disclose", "directly notifies"],
        ["public archive", "change log"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-tos"],
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-user"],
        ["#glossary-clearlydisclose", "#glossary-direct"],
        ["#glossary-publicarchive", "#glossary-changelog"]
      ],
      ...
      "sources": "Company terms of service"
    },
    {
      "indicator": "F2b",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "directly notify"],
        ["clearly disclose", "directly notifies", "users"],
        ["public archive", "change log"],
        ["mobile ecosystems", "clearly disclose", "apps", "app store", "users", "apps", "advertising content policies"],
        ["personal digital assistant ecosystems", "clearly disclose", "skills", "skill store", "skills", "advertising content policies"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-advertisingcontentpolicies"],
        ["#glossary-clearlydisclose", "#glossary-direct"],
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-user "],
        ["#glossary-publicarchive", "#glossary-changelog"],
        ["#glossary-mobile", "#glossary-clearlydisclose", "#glossary-app", "#glossary-appstore", "#glossary-user", "#glossary-app", "#glossary-advertisingcontentpolicies"],
        ["#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-skills", "#glossary-skillstore", "#glossary-skills", "#glossary-advertisingcontentpolicies"]
      ],
      ...
      "sources": ["Advertising policies, guidelines, terms of use, etc.", "Company Ads or Business Help Center"]
    },
    {
      "indicator": "F2c",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "directly notifies"],
        ["public archive", "change log"],
        ["mobile ecosystems", "clearly disclose", "apps", "app store", "directly notify", "apps", "advertising targeting policies"],
        ["personal digital assistant ecosystems", "clearly disclose", "skills", "skill store", "notify", "users", "skills", "advertising targeting policies"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-user", "#glossary-advertisingcontentpolicies"],
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-user"],
        ["#glossary-clearlydisclose", "#glossary-direct"],
        ["#glossary-publicarchive", "#glossary-changelog"],
        ["#glossary-mobile", "#glossary-clearlydisclose", "#glossary-app", "#glossary-appstore", "#glossary-direct", "#glossary-app", "#glossary-advertisingcontentpolicies"],
        ["#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-skills", "#glossary-skillstore", "#glossary-direct", "#glossary-user", "#glossary-skills", "#glossary-advertisingcontentpolicies"]
      ],
    ...
    },
    {
      ...
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-user", "#glossary-algsysuse"],
        ["#glossary-clearlydisclose", "#glossary-direct"],
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-user"],
        ["#glossary-publicarchive", "#glossary-changelog"]
      ],
    ...
    },
    {
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "user's account"],
        ["clearly disclose", "content", "accounts"],
        ["clearly disclose", "algorithmic systems", "content"],
        ["clearly disclose", "flagging", "content"],
        ["clearly disclose", "flagging", "content"],
        ["clearly disclose"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-content"],
        ["#glossary-clearlydisclose", "#glossary-account"],
        ["#glossary-clearlydisclose", "#glossary-content", "#glossary-account"],
        ["#glossary-clearlydisclose", "#glossary-algsys", "#glossary-content"],
        ["#glossary-clearlydisclose", "#glossary-flag", "#glossary-content"],
        ["#glossary-clearlydisclose", "#glossary-flag", "#glossary-content"],
        ["#glossary-clearlydisclose"]
      ],
      ...
      "sources": ["Company terms of service, user agreements", "Company acceptable use policy, community standards, content guidelines, abusive behavior policy, or similar document that explains the rules users have to follow.", "Company support, help center, or FAQ"]
    },
    {
      "indicator": "F3b",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "requires", "advertising content"],
        ["clearly disclose", "advertising content", "accounts"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-advertisingcontent"],
        ["#glossary-clearlydisclose", "#glossary-require", "#glossary-advertisingcontent"],
        ["#glossary-clearlydisclose", "#glossary-advertisingcontent", "#glossary-account"]
      ],
      ...
      "sources": ["Company advertiser portal, ad policy, political ad policy", "Company terms of service, user contract", "Company acceptable use policy, community standards, content guidelines", "Company support, help center, or FAQ"]
    },
    {
      "indicator": "F3c",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "targeting parameters"],
        ["clearly disclose", "advertisers"],
        ["clearly disclose", "algorithmically", "advertising audience categories"],
        ["clearly disclose", "advertising content", "accounts"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-thirdparty", "#glossary-user", "#glossary-advertisingcontent"],
        ["#glossary-clearlydisclose", "#glossary-targetingpar"],
        ["#glossary-clearlydisclose", "#glossary-advertiser"],
        ["#glossary-clearlydisclose", "#glossary-algorithm", "#glossary-advertisingaudiencecategories"],
        ["#glossary-clearlydisclose", "#glossary-advertisingcontent", "#glossary-account"]
      ],
      "guidance": "The ability for advertisers or other third parties to target users with tailored content—based on their browsing behaviors, location information, and other data and characteristics that have been inferred about them—can significantly shape a user’s online ecosystem. Targeting, which can include both paid and unpaid content, can amplify offline social inequities and can be overtly discriminatory. It can also result in so-called “filter bubbles,” as well as spread problematic content, including content intended to mislead or to spread falsehoods. Therefore, companies that enable advertisers and other third parties to target their users with tailored ads or content should have clear policies describing their ad targeting rules. Companies should clearly disclose whether they enable third parties to target their users with tailored ads or other types of sponsored content , and clearly disclose what targeting parameters—like using certain types of audience categories, like age, location, or other user characteristics—are not permitted. Companies should also disclose their processes for identifying breaches to targeting rules.",
      "sources": ["Company advertiser portal, ad policy, political ad policy", "Company acceptable use policy", "Company support, help center, or advertiser FAQ"]
    },
    {
      "indicator": "F4a",
      ...
      "elementsLinks": [
        ["#glossary-contentrestriction"],
        ["#glossary-contentrestriction"],
        ["#glossary-content", "#glossary-contentrestriction"],
        ["#glossary-content", "#glossary-contentrestriction"],
        [],
      ...
      "sources": ["Company transparency report", "Company community standards enforcement report, community guidelines enforcement report, etc."]
    },
    {
      "indicator": "F4b",
    ...
    },
    {
      ...
      "elementsTags": [
        ...
        ["advertisements", "restricted", "advertising content"],
        ["advertisements", "restricted", "advertising targeting policies"],
        ["advertisements", "restricted", "advertising targeting rule"],
        [],
        ["structured data"]
      ],
      "elementsLinks": [
        ["#glossary-advertisement", "#glossary-contentrestriction", "#glossary-advertisingcontentpolicies"],
        ["#glossary-advertisement", "#glossary-contentrestriction", "#glossary-advertisingcontentpolicies"],
        ["#glossary-advertisement", "#glossary-contentrestriction", "#glossary-advertisingtargetingpolicies"],
        ["#glossary-advertisement", "#glossary-contentrestriction", "#glossary-advertisingtargetingpolicies"],
        [],
        ["#glossary-structureddata"]
      ],
    ...
    },
    {
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "court orders"],
        ["clearly disclose", "government demands"],
        ["clearly disclose", "government demands"],
        ["clearly disclose", "government demands"],
        ["demands made by governments"],
        ["government demands"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-govdemands"],
        ["#glossary-clearlydisclose", "#glossary-courtorders"],
        ["#glossary-clearlydisclose", "#glossary-govdemands"],
        ["#glossary-clearlydisclose", "#glossary-govdemands"],
        ["#glossary-clearlydisclose", "#glossary-govdemands"],
        ["#glossary-govdemands"],
      ...
      "sources": ["Company transparency report", "Company law enforcement guidelines", "Company annual reports"]
    },
    {
      "indicator": "F5b",
      ...
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-privateprocesses", "#glossary-privateprocesses"],
        ["#glossary-clearlydisclose", "#glossary-privateprocesses", "#glossary-privateprocesses"],
        ["#glossary-clearlydisclose", "#glossary-privateprocesses", "#glossary-privateprocesses"],
        ["#glossary-privateprocesses"],
        ["#glossary-privateprocesses", "#glossary-privateprocesses"]
      ],
      ...
      "sources": ["Company transparency report", "Company help or support center", "Company blog posts", "Company policy on copyright or intellectual property"]
    },
    {
      "indicator": "F6",
    ...
    },
    {
      ...
      "elementsLinks": [
        ["#glossary-contentrestriction", "#glossary-account"],
        ["#glossary-account"],
        ["#glossary-contentrestriction"],
        [],
        ["#glossary-clearlydisclose", "#glossary-privateprocesses"],
        [],
        ["#glossary-publicthird"],
        [],
        ["#glossary-structureddata"],
        ["#glossary-clearlydisclose", "#glossary-privateprocesses"]
      ],
    ...
    },
    {
      ...
      "elementsTags": [
        ["clearly disclose", "content"],
        ["clearly disclose", "content"],
        ["clearly disclose", "content restriction"],
        ["clearly disclose", "accounts"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-contentrestriction"],
        ["#glossary-clearlydisclose", "#glossary-contentrestriction"],
        ["#glossary-clearlydisclose", "#glossary-contentrestriction"],
        ["#glossary-clearlydisclose", "#glossary-account"]
      ],
      ...
      "sources": ["Company terms of service, acceptable use policy", "Company community standards", "Company support page, help center, or FAQ", "Company guidelines for developers", "Company human rights policy"]
    },
    {
      "indicator": "F9",
      ...
      "elementsTags": [
        ...
        ["zero-rating programs", "prioritize"],
        ["prioritization", "clearly disclose"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-prioritization", "#glossary-app", "#glossary-protocol", "#glossary-content"],
        ["#glossary-zerorating", "#glossary-prioritization"],
        ["#glossary-prioritization", "#glossary-clearlydisclose"]
      ],
      ...
      "sources": ["Company network management or traffic management policies", "Company annual reports"]
    },
    {
      "indicator": "F10",
      ...
      "elementsTags": [
        ["clearly disclose"],
        ["clearly disclose", "applications", "protocols"],
        ["clearly disclose", "government demands", "shut down a network or restrict access to a service"],
        ["clearly disclose", "government demands", "shut down a network or restrict access to a service"],
        ["clearly disclose", "shuts down a network or restricts access to a service"],
        ["clearly disclose", "network shutdown"],
        ["clearly disclose", "demands"],
        ["clearly disclose", "government demands"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose"],
        ["#glossary-clearlydisclose", "#glossary-app", "#glossary-protocol"],
        ["#glossary-clearlydisclose", "#glossary-govdemands", "#glossary-shutdown"],
        ["#glossary-clearlydisclose", "#glossary-govdemands", "#glossary-shutdown"],
        ["#glossary-clearlydisclose", "#glossary-shutdown"],
        ["#glossary-clearlydisclose", "#glossary-shutdown"],
        ["#glossary-clearlydisclose", "#glossary-govdemands"],
        ["#glossary-clearlydisclose", "#glossary-govdemands"]
      ],
      ...
      "sources": ["Company terms of service", "Company transparency report", "Company law enforcement guidelines", "Company human rights policy"]
    },
    {
      "indicator": "F11",
      ...
      "elementsLinks": [
        ["#glossary-require", "#glossary-governmentid"]
      ],
      ...
      "sources": ["Company terms of service or equivalent document", "Company help center", "Company sign up page"]
    },
    {
      "indicator": "F12",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "algorithmic systems", "curate, recommend, and/or rank", "content"],
        ["clearly disclose", "algorithmic content curation, recommendation, and/or ranking system"],
        ["clearly disclose", "curate, recommend, and/or rank content"],
        ["clearly disclose", "curation, recommendation, and/or ranking systems"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-algsys", "#glossary-algcontent", "#glossary-content"],
        ["#glossary-clearlydisclose", "#glossary-algsys", "#glossary-algcontent", "#glossary-content"],
        ["#glossary-clearlydisclose", "#glossary-algcontent"],
        ["#glossary-clearlydisclose", "#glossary-algcontent"],
        ["#glossary-clearlydisclose", "#glossary-algcontent"]
      ],
      ...
      "sources": ["Company human rights policy", "Company artificial intelligence policies, including AI principles, frameworks, and use guidelines", "Help pages describing how feed settings, home page settings, search results, recommendations, user interests, or topics are affected by algorithms"]
    },
    {
      "indicator": "F13",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "users", "content", "accounts", "bot"],
        ["clearly disclose", "bot policy"],
        ["clearly disclose", "content", "account", "bot policy"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-bot"],
        ["#glossary-clearlydisclose", "#glossary-user", "#glossary-content", "#glossary-account", "#glossary-bot"],
        ["#glossary-clearlydisclose", "#glossary-botpolicy"],
        ["#glossary-clearlydisclose", "#glossary-content", "#glossary-account", "#glossary-botpolicy"]
      ],
      ...
      "sources": ["Platform policies for developers", "Automation or bot rules", "Transparency reports"]
    },
    {
      "indicator": "P1a",
      ...
      "elementsTags": [
        ...
        ["mobile ecosystems", "apps", "app store", "users", "privacy policy"],
        ["personal digital assistant ecosystems", "skills", "skill store", "users", "privacy policy"]
      ],
      "elementsLinks": [
        ["#glossary-privacypolicies", "#glossary-easytofind"],
        ["#glossary-privacypolicies"],
        ["#glossary-easytounderstand"],
        ["#glossary-mobile", "#glossary-app", "#glossary-appstore", "#glossary-user", "#glossary-privacypolicies"],
        ["#glossary-personaldig", "#glossary-skills", "#glossary-skillstore", "#glossary-user", "#glossary-privacypolicies"]
      ],
      ...
      "sources": ["Company privacy policy", "Company data use policy"]
    },
    {
      "indicator": "P1b",
    ...
    },
    {
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "directly", "notifies", "users"],
        ["public archive", "change log"],
        ["clearly disclose", "users", "privacy policy"],
        ["personal digital assistant ecosystems", "clearly disclose", "skills", "skill store", "users", "privacy policy"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-notice", "#glossary-user", "#glossary-privacypolicies"],
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-user"],
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-direct", "#glossary-user"],
        ["#glossary-publicarchive", "#glossary-changelog"],
        ["#glossary-clearlydisclose", "#glossary-user", "#glossary-privacypolicies"],
        ["#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-skills", "#glossary-skillstore", "#glossary-user", "#glossary-privacypolicies"]
      ],
    ...
    },
    {
      ...
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-user", "#glossary-algsysdev"],
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-user"],
        ["#glossary-clearlydisclose", "#glossary-direct", "#glossary-direct", "#glossary-user"],
        []
      ],
      ...
      "sources": ["Company algorithmic use policy", "Privacy policy or data policy"]
    },
    {
      "indicator": "P3a",
      ...
      "elementsTags": [
        ...
        ["user information", "collects", "clearly disclose"],
        ["clearly disclose", "limits collection", "user information"],
        ["mobile ecosystems", ")", "clearly disclose", "privacy policies", "apps", "app store", "user information", "collect"],
        ["mobile ecosystems", "clearly disclose", "apps", "app store", "limit collection", "user information"],
        ["personal digital assistant ecosystems", "clearly disclose", "privacy policies", "skills", "skill store", "user information", "collect"],
        ["personal digital assistant ecosystems", "clearly disclose", "skills", "skill store", "limit collection", "user information"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-userinformation", "#glossary-collect"],
        ["#glossary-userinformation", "#glossary-collect", "#glossary-clearlydisclose"],
        ["#glossary-clearlydisclose", "#glossary-limitation", "#glossary-userinformation"],
        ["#glossary-mobile", "#glossary-mobile", "#glossary-clearlydisclose", "#glossary-privacypolicies", "#glossary-app", "#glossary-appstore", "#glossary-userinformation", "#glossary-collect"],
        ["#glossary-mobile", "#glossary-clearlydisclose", "#glossary-app", "#glossary-appstore", "#glossary-limitation", "#glossary-userinformation"],
        ["#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-privacypolicies", "#glossary-skills", "#glossary-skillstore", "#glossary-userinformation", "#glossary-collect"],
        ["#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-skills", "#glossary-skillstore", "#glossary-limitation", "#glossary-userinformation"]
      ],
      ...
      "sources": ["Company privacy policy", "Company webpage or section on data protection or data collection"]
    },
    {
      "indicator": "P3b",
    ...
    },
    {
      ...
      "elementsTags": [
        ...
        ["user information", "shares", "clearly disclose", "third parties", "shares"],
        ["clearly disclose", "share", "user information"],
        ["user information", "shares", "clearly disclose", "third parties", "shares"],
        ["mobile ecosystems", "clearly disclose", "privacy policies", "third party", "apps", "app store", "user information", "share"],
        ["mobile ecosystems", "clearly disclose", "privacy policies", "third party", "apps", "app store", "third parties", "share", "user information"],
        ["personal", "digital assistant ecosystems", "clearly disclose", "privacy policies", "third party", "skills", "skill store", "user information", "share"],
        ["personal digital assistant ecosystems", "clearly disclose", "privacy policies", "third party", "skills", "skill store", "third parties", "share", "user information"]
      ],
      "elementsLinks": [
        ["#glossary-userinformation", "#glossary-clearlydisclose", "#glossary-shares"],
        ["#glossary-userinformation", "#glossary-shares", "#glossary-clearlydisclose", "#glossary-thirdparty", "#glossary-shares"],
        ["#glossary-clearlydisclose", "#glossary-shares", "#glossary-userinformation"],
        ["#glossary-userinformation", "#glossary-shares", "#glossary-clearlydisclose", "#glossary-thirdparty", "#glossary-shares"],
        ["#glossary-mobile", "#glossary-clearlydisclose", "#glossary-privacypolicies", "#glossary-thirdparty", "#glossary-app", "#glossary-appstore", "#glossary-userinformation", "#glossary-shares"],
        ["#glossary-mobile", "#glossary-clearlydisclose", "#glossary-privacypolicies", "#glossary-thirdparty", "#glossary-app", "#glossary-appstore", "#glossary-thirdparty", "#glossary-shares", "#glossary-userinformation"],
        ["#glossary-personaldig", "#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-privacypolicies", "#glossary-thirdparty", "#glossary-skills", "#glossary-skillstore", "#glossary-userinformation", "#glossary-shares"],
        ["#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-privacypolicies", "#glossary-thirdparty", "#glossary-skills", "#glossary-skillstore", "#glossary-thirdparty", "#glossary-shares", "#glossary-userinformation"]
      ],
    ...
    },
    {
      ...
      "elementsTags": [
        ...
        ["user information", "infers", "clearly disclose", "inference"],
        ["clearly disclose", "user information"],
        ["user information", "shares", "clearly disclose"],
        ["clearly disclose", "user information", "collect", "inferred"]
      ],
      "elementsLinks": [
        ["#glossary-userinformation", "#glossary-collect", "#glossary-clearlydisclose", "#glossary-collect"],
        ["#glossary-userinformation", "#glossary-datainf", "#glossary-clearlydisclose", "#glossary-datainf"],
        ["#glossary-clearlydisclose", "#glossary-userinformation"],
        ["#glossary-userinformation", "#glossary-shares", "#glossary-clearlydisclose"],
        ["#glossary-clearlydisclose", "#glossary-userinformation", "#glossary-collect", "#glossary-datainf"]
      ],
      ...
      "sources": "Company privacy policy"
    },
    {
      "indicator": "P6",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "de-identified", "user information"],
        ["clearly disclose", "de-identifying", "user information"],
        ["clearly disclose", "user information"],
        ["clearly disclose", "user information"],
        ["mobile ecosystems", "clearly disclose", "privacy policies", "third-party", "apps", "app store", "user information"],
        ["mobile ecosystems", "clearly disclose", "privacy policies", "third-party", "apps", "app store", "user information", "app"],
        ["personal digital assistant ecosystems", "clearly disclose", "privacy policies", "third-party", "skills", "skill store", "user information"],
        ["personal digital assistant ecosystems", "clearly disclose", "privacy policies", "third-party", "skills", "skill store", "user information", "skill"]
      ],
      "elementsLinks": [
        ["#glossary-userinformation", "#glossary-clearlydisclose", "#glossary-retention"],
        ["#glossary-clearlydisclose", "#glossary-deidentified", "#glossary-userinformation"],
        ["#glossary-clearlydisclose", "#glossary-deidentified", "#glossary-userinformation"],
        ["#glossary-clearlydisclose", "#glossary-userinformation"],
        ["#glossary-clearlydisclose", "#glossary-userinformation"],
        ["#glossary-mobile", "#glossary-clearlydisclose", "#glossary-privacypolicies", "#glossary-thirdparty", "#glossary-app", "#glossary-appstore", "#glossary-userinformation"],
        ["#glossary-mobile", "#glossary-clearlydisclose", "#glossary-privacypolicies", "#glossary-thirdparty", "#glossary-app", "#glossary-appstore", "#glossary-userinformation", "#glossary-appstore"],
        ["#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-privacypolicies", "#glossary-thirdparty", "#glossary-skills", "#glossary-skillstore", "#glossary-userinformation"],
        ["#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-privacypolicies", "#glossary-thirdparty", "#glossary-skills", "#glossary-skillstore", "#glossary-userinformation", "#glossary-skills"]
      ],
    ...
    },
    {
      ...
      "elementsTags": [
        ...
        ["user information", "collects", "clearly disclose", "users", "user information"],
        ["user information", "infers", "collected", "clearly disclose", "users", "infer", "user information"],
        ["user information", "infers", "collected", "clearly disclose", "users", "user information"],
        ["clearly disclose", "users", "options to control", "user information", "targeted advertising"],
        [],
        ["clearly disclose", "users", "options to control", "user information", "algorithmic systems"],
        ["clearly disclose", "user information", "algorithmic systems"],
        ["mobile ecosystems", "clearly disclose", "users", "options to control", "geolocation"]
      ],
      "elementsLinks": [
        ["#glossary-userinformation", "#glossary-collect", "#glossary-clearlydisclose", "#glossary-user", "#glossary-collect", "#glossary-userinformation"],
        ["#glossary-userinformation", "#glossary-collect", "#glossary-clearlydisclose", "#glossary-user", "#glossary-userinformation"],
        ["#glossary-userinformation", "#glossary-datainf", "#glossary-collect", "#glossary-clearlydisclose", "#glossary-user", "#glossary-datainf", "#glossary-userinformation"],
        ["#glossary-userinformation", "#glossary-datainf", "#glossary-collect", "#glossary-clearlydisclose", "#glossary-user", "#glossary-userinformation"],
        ["#glossary-clearlydisclose", "#glossary-user", "#glossary-options", "#glossary-userinformation", "#glossary-targetedad"],
        [],
        ["#glossary-clearlydisclose", "#glossary-user", "#glossary-options", "#glossary-userinformation", "#glossary-algsys"],
        ["#glossary-clearlydisclose", "#glossary-userinformation", "#glossary-algsys"],
        ["#glossary-mobile", "#glossary-clearlydisclose", "#glossary-user", "#glossary-options", "#glossary-geo"]
      ],
      ...
      "sources": ["Company privacy policy", "Company account settings page, privacy dashboards", "Company help center"]
    },
    {
      "indicator": "P8",
      ...
      "elementsTags": [
        ["clearly disclose", "user information"],
        ["clearly disclose", "user information", "users"],
        ["clearly disclose", "users", "user information"],
        ["clearly disclose", "users", "user information"],
        ["clearly disclose", "users", "advertising audience categories"],
        ["clearly disclose", "users", "infer"],
        ["mobile ecosystems", "clearly disclose", "privacy policies", "third-party", "apps", "app store", "users", "user information"],
        ["personal digital assistant ecosystems", "clearly disclose", "privacy policies", "third-party", "skills", "skill store", "user information", "users", "skill"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-userinformation"],
        ["#glossary-clearlydisclose", "#glossary-userinformation", "#glossary-user"],
        ["#glossary-clearlydisclose", "#glossary-user", "#glossary-userinformation"],
        ["#glossary-clearlydisclose", "#glossary-user", "#glossary-userinformation"],
        ["#glossary-clearlydisclose", "#glossary-user", "#glossary-audvertisingaudiencecategories"],
        ["#glossary-clearlydisclose", "#glossary-user", "#glossary-datainf"],
        ["#glossary-mobile", "#glossary-clearlydisclose", "#glossary-privacypolicies", "#glossary-thirdparty", "#glossary-app", "#glossary-appstore", "#glossary-user", "#glossary-userinformation"],
        ["#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-privacypolicies", "#glossary-thirdparty", "#glossary-skills", "#glossary-skillstore", "#glossary-userinformation", "#glossary-user", "#glossary-skills"]
      ],
      ...
      "sources": ["Company privacy policy", "Company account settings", "Company help center", "Company blog posts"]
    },
    {
      "indicator": "P9",
      ...
      "elementsTags": [
        ...
        ["user information", "third parties", "technical means"],
        ["clearly disclose", "user information", "third parties", "technical means"],
        ["clearly disclose", "user information", "third parties", "technical means"],
        ["clearly disclose"],
        ["clearly disclose", "user information", "third parties", "non-technical means"],
        ["clearly disclose", "user information", "third parties", "non-technical means"],
        ["clearly disclose", "user information", "third parties", "non-technical means"],
        ["clearly disclose", "user information", "non-technical means"]
      ],
      "elementsLinks": [
        ["#glossary-userinformation", "#glossary-technicalmeans"],
        ["#glossary-userinformation", "#glossary-thirdparty", "#glossary-technicalmeans"],
        ["#glossary-clearlydisclose", "#glossary-userinformation", "#glossary-thirdparty", "#glossary-technicalmeans"],
        ["#glossary-clearlydisclose", "#glossary-userinformation", "#glossary-thirdparty", "#glossary-technicalmeans"],
        ["#glossary-clearlydisclose"],
        ["#glossary-clearlydisclose", "#glossary-userinformation", "#glossary-thirdparty", "#glossary-nontech"],
        ["#glossary-clearlydisclose", "#glossary-userinformation", "#glossary-thirdparty", "#glossary-nontech"],
        ["#glossary-clearlydisclose", "#glossary-userinformation", "#glossary-thirdparty", "#glossary-nontech"],
        ["#glossary-clearlydisclose", "#glossary-userinformation", "#glossary-nontech"]
      ],
      ...
      "sources": ["Company privacy policy", "Company policy on third parties or cookies policy"]
    },
    {
      "indicator": "P10a",
      ...
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-nonjudicial", "#glossary-nonjudicial"],
        ["#glossary-clearlydisclose", "#glossary-courtorders"],
        ["#glossary-clearlydisclose", "#glossary-govdemands"],
        ["#glossary-clearlydisclose", "#glossary-govdemands"],
        ["#glossary-clearlydisclose", "#glossary-govdemands"],
      ...
      "sources": ["Company transparency report", "Company law enforcement guidelines", "Company privacy policy", "Company sustainability report", "Company blog posts"]
    },
    {
      "indicator": "P10b",
    ...
    },
    {
      ...
      "elementsTags": [
        ["government", "demands"],
        ["government", "demands", "real-time communications access"],
        [],
        ["content", "non-content"],
        [],
        ["government", "demands", "court orders"],
        ["government", "demands"],
        ["government", "demands"],
        [],
        ["structured data"]
      ...
      "elementsLinks": [
        ["#glossary-govdemands", "#glossary-govdemands"],
        ["#glossary-govdemands", "#glossary-govdemands", "#glossary-realtime"],
        [],
        ["#glossary-content", "#glossary-noncontent"],
        [],
        ["#glossary-govdemands", "#glossary-govdemands", "#glossary-courtorders"],
        ["#glossary-govdemands", "#glossary-govdemands"],
        ["#glossary-govdemands", "#glossary-govdemands"],
        [],
        ["https://www.google.com/url?q=https://rankingdigitalrights.org/2019-indicators/%23structureddata&sa=D&ust=1591114490465000"]
      ],
      ...
      "sources": ["Company transparency report,", "Company law enforcement report", "Company sustainability report"]
    },
    {
      "indicator": "P11b",
      ...
      "elementsTags": [
        ...
        ["user information", "private", "proc", "esses"],
        [],
        ["structured data"]
      ],
      "elementsLinks": [
        ["#glossary-userinformation", "#glossary-privateprocesses"],
        ["#glossary-userinformation", "#glossary-privateprocesses", "#glossary-privateprocesses", "#glossary-privateprocesses"],
        [],
        ["structureddata"]
      ],
      ...
      "sources": ["Company transparency report", "Company sustainability report", "Corporate social responsibility report"]
    },
    {
      "indicator": "P12",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "notifies", "user information", "private processes"],
        ["clearly disclose", "notify", "government demands"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-govdemands", "https://docs.google.com/document/d/1csFnne1LyCLP1TMylmugABL8RUn9PGVIf49z0tKMtz0/edit#bookmark=id.w0ipnpr2810d", "#glossary-userinformation"],
        ["#glossary-clearlydisclose", "#glossary-notice", "#glossary-userinformation", "#glossary-privateprocesses"],
        ["#glossary-clearlydisclose", "#glossary-notice", "#glossary-govdemands"]
      ],
      ...
      "sources": ["Company transparency report", "Company law enforcement guidelines", "Company privacy policy", "Company human rights policy"]
    },
    {
      "indicator": "P13",
      ...
      "sources": ["Company privacy policies", "Company security guide"]
    },
    {
      "indicator": "P14",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "vulnerabilities"],
        ["researchers", "vulnerabilities"],
        ["personal digital assistant ecosystems", "clearly disclose", "software updates", "patches", "encrypted"],
        ["clearly disclose", "modifications", "mobile operating system"],
        ["personal digital assistant ecosystems", "clearly disclose", "security updates"],
        ["personal digital assistant ecosystems", "clearly disclose", "security updates", "device/OS"],
        ["personal digital assistant ecosystems", "security updates"],
        ["personal digital assistant ecosystems", "patches", "vulnerability"],
        ["personal digital assistant ecosystems", "clearly disclose"],
        ["personal digital assistant ecosystems", "clearly disclose"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-securityresearcher", "#glossary-securityvulnerability"],
        ["#glossary-clearlydisclose", "#glossary-securityvulnerability"],
        ["#glossary-securityresearcher", "#glossary-securityvulnerability"],
        ["#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-softwareupdate", "#glossary-patch", "#glossary-encryption"],
        ["#glossary-clearlydisclose", "#glossary-modifications", "#glossary-os"],
        ["#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-securityupdate"],
        ["#glossary-personaldig", "#glossary-clearlydisclose", "#glossary-securityupdates", "#glossary-device"],
        ["#glossary-personaldig", "#glossary-securityupdates"],
        ["#glossary-personaldig", "#glossary-patch", "#glossary-securityvulnerability"],
        ["#glossary-personaldig", "#glossary-clearlydisclose"],
        ["#glossary-personaldig", "#glossary-clearlydisclose"]
      ],
      ...
      "sources": ["Company privacy policies", "Company security guide", "Company “help” forums"]
    },
    {
      "indicator": "P15",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "notifying", "data breach"],
        ["clearly disclose", "data breach"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-databreach"],
        ["#glossary-clearlydisclose", "#glossary-notify", "#glossary-databreach"],
        ["#glossary-clearlydisclose", "#glossary-databreach"]
      ],
      ...
      "sources": ["Company terms of service or privacy policy", "Company security guide"]
    },
    {
      "indicator": "P16",
      ...
      "elementsTags": [
        ...
        ["clearly disclose", "encrypted"],
        ["clearly disclose", "end-to-end encryption", "full-disk encryption"],
        ["clearly disclose", "end-to-end encryption", "full-disk encryption"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose", "#glossary-encrypt"],
        ["#glossary-clearlydisclose", "#glossary-encrypt"],
        ["#glossary-clearlydisclose", "#glossary-endtoend", "#glossary-fulldisk"],
        ["#glossary-clearlydisclose", "#glossary-endtoend", "#glossary-fulldisk"]
      ],
      ...
      "sources": ["Company terms of service or privacy policy", "Company security guide", "Company help center", "Company sustainability reports", "Official company blog and/or press releases"]
    },
    {
      "indicator": "P17",
      ...
      "elementsTags": [
        ["clearly disclose"],
        ["clearly disclose"],
        ["clearly disclose", "notifies", "users"]
      ],
      "elementsLinks": [
        ["#glossary-clearlydisclose"],
        ["#glossary-clearlydisclose"],
        ["#glossary-clearlydisclose", "#glossary-notifies", "#glossary-users"]
      ],
      ...
      "sources": ["Company security center", "Company help pages or community support page", "Company account settings page", "Company blog"]
    },
    {
      "indicator": "P18",
